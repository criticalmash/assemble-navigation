...
/**
 * Sort menu items recursively using the supplied function.
 *
 * function is similar to Array.sort() but can accept a third
 * parameter representing the parent of the two menu items
 * being compared.
 * 
 * ```
 * myMenu.sort(function (a, b, parent){
 *   // do some sorting and return a value
 * });
 * 
...
/**
 * Recursively crawls the given branch (parent) and sorts
 * any items if finds.
 * Create a custom sorter for items and apply
 * @param  {Object}   parent the branch being sorted
 * @param  {Function} fn     User supplied sorting function
 */
...
/**
 * Wraps user supplied sorting function in a function compatible with
 * Array.sort()
 * @param  {Object}   parent reference to parent menu item or menu
 * @param  {Function} fn     Sorting function supplied by user
